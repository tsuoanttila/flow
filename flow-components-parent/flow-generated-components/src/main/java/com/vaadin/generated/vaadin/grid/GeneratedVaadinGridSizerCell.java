...
@Generated({
		...
		"WebComponent: vaadin-grid-sizer-cell#UNKNOWN", "Flow#0.1.17-SNAPSHOT"})
@Tag("vaadin-grid-sizer-cell")
@HtmlImport("frontend://bower_components/vaadin-grid/vaadin-grid-table-cell.html")
public class GeneratedVaadinGridSizerCell<R extends GeneratedVaadinGridSizerCell<R>>
		extends
