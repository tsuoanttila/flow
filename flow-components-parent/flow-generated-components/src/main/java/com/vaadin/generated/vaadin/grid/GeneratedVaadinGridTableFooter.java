...
@Generated({
		...
		"WebComponent: vaadin-grid-table-footer#UNKNOWN",
		"Flow#0.1.17-SNAPSHOT"})
@Tag("vaadin-grid-table-footer")
@HtmlImport("frontend://bower_components/vaadin-grid/vaadin-grid-table-header-footer.html")
public class GeneratedVaadinGridTableFooter<R extends GeneratedVaadinGridTableFooter<R>>
		extends
