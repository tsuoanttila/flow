...
@Generated({
		...
		"WebComponent: vaadin-grid-table-row#null", "Flow#0.1.17-SNAPSHOT"})
@Tag("vaadin-grid-table-row")
@HtmlImport("frontend://bower_components/vaadin-grid/vaadin-grid-table-row.html")
public class GeneratedVaadinGridTableRow<R extends GeneratedVaadinGridTableRow<R>>
		extends
