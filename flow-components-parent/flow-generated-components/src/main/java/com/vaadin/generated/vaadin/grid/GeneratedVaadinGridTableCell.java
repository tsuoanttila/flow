...
@Generated({
		...
		"WebComponent: vaadin-grid-table-cell#null", "Flow#0.1.17-SNAPSHOT"})
@Tag("vaadin-grid-table-cell")
@HtmlImport("frontend://bower_components/vaadin-grid/vaadin-grid-table-cell.html")
public class GeneratedVaadinGridTableCell<R extends GeneratedVaadinGridTableCell<R>>
		extends
