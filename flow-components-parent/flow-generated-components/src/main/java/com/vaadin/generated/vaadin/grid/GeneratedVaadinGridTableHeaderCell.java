...
@Generated({
		...
		"WebComponent: vaadin-grid-table-header-cell#UNKNOWN",
		"Flow#0.1.17-SNAPSHOT"})
@Tag("vaadin-grid-table-header-cell")
@HtmlImport("frontend://bower_components/vaadin-grid/vaadin-grid-table-cell.html")
public class GeneratedVaadinGridTableHeaderCell<R extends GeneratedVaadinGridTableHeaderCell<R>>
		extends
	 ...
	 * the returned value may not be the same as in client side.
	 */
	protected JsonObject protectedGetHeaderTemplate() {
		return (JsonObject) getElement().getPropertyRaw("headerTemplate");
	}
	 ...
	 * @return this instance, for method chaining
	 */
	protected R setHeaderTemplate(elemental.json.JsonObject headerTemplate) {
		getElement().setPropertyJson("headerTemplate", headerTemplate);
		return get();
	}
	 ...
	 * the returned value may not be the same as in client side.
	 */
	public boolean isColumnResizing() {
		return getElement().getProperty("columnResizing", false);
	}

	/**
	 * @param columnResizing
	 *            the boolean value to set
	 * @return this instance, for method chaining
	 */
	public R setColumnResizing(boolean columnResizing) {
		getElement().setProperty("columnResizing", columnResizing);
		return get();
	}
}