...
@Generated({
		...
		"WebComponent: vaadin-grid-table-footer-row#UNKNOWN",
		"Flow#0.1.17-SNAPSHOT"})
@Tag("vaadin-grid-table-footer-row")
@HtmlImport("frontend://bower_components/vaadin-grid/vaadin-grid-table-row.html")
public class GeneratedVaadinGridTableFooterRow<R extends GeneratedVaadinGridTableFooterRow<R>>
		extends
